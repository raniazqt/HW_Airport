...
public class DisplayBaggageInfoScreen extends javax.swing.JFrame {
    ...
    public DisplayBaggageInfoScreen() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Please complete the information about your baggage", 0, 0, new java.awt.Font("Helvetica", 1, 14))); // NOI18N
        ...
        Category.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "First Class", "Business Class", "Economy Class" }));
        ...
        FeesToPay.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pay Excess Baggage Fees",  "No Baggage to Check In" }));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(FeesToPay, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Height, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(FeesToPay, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel9)
            ...
            if(Length.getText().isEmpty() || Length.getText().charAt(0) == ' '){
                ...
                try {
                    ...
                    while((f = br.readLine())!=null){
                        ...
                        if(parts[2].equals(Email.getText()) && parts[5].equals(Category.getSelectedItem().toString())){
                            chk = 1;
                            break;
                        }
                ...
                if(chk==1){
                    JOptionPane.showMessageDialog(null, "Another Passenger with this Email is already Selected!!");
                            ...
                            fout.write(Pno.getText()+","+Length.getText()+","+Email.getText()+","+Width.getText()+","+Height.getText()+","+Category.getSelectedItem().toString()+","+FeesToPay.getSelectedItem().toString());
