...
public class FlightPanel implements GUIElement
{
    ...
    public String getActiveFlightCode() {return activeFlightCode;}
    public void setActiveFlightCode(String activeFlightCode) { this.activeFlightCode = activeFlightCode;}
    ...
    private void updateDataModels(Object args)
    {
        ...
        model.setDataVector(data, new String[] {"Status", "Value"});
